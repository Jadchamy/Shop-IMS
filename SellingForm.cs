...
namespace Shop
{
    public partial class SellingForm : Form
    {
        ...
        SqlConnection Con = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=""C:\IMS App\DB\inventoryDB.mdf"";Integrated Security=True;Connect Timeout=30");
        ...
        {
            e.Graphics.DrawString("مؤسسة احمد السيد", new Font("Ariel", 30, FontStyle.Bold), Brushes.Maroon, new Point(250));
